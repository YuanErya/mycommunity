DROP DATABASE IF EXISTS my_community;
CREATE DATABASE IF NOT EXISTS my_community;
USE my_community;

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS `mc_billboard`;
CREATE TABLE `mc_billboard`  (
...
-- ----------------------------
INSERT INTO `mc_billboard` VALUES (2, 'R1.0 开始已实现护眼模式 ,妈妈再也不用担心我的眼睛了。', '2020-11-19 17:16:19', 0);
INSERT INTO `mc_billboard` VALUES (4, '系统已更新至最新版1.0.1', NULL, 1);
...
-- ----------------------------
INSERT INTO `mc_follow` VALUES (65, '1329723594994229250', '1317498859501797378');
INSERT INTO `mc_follow` VALUES (85, '1332912847614083073', '1332636310897664002');
INSERT INTO `mc_follow` VALUES (129, '1349290158897311745', '1349618748226658305');

-- ----------------------------
-- Table structure for bms_post
-- ----------------------------
DROP TABLE IF EXISTS `mc_post`;
CREATE TABLE `mc_post`  (
...
-- Records of bms_tag
-- ----------------------------
INSERT INTO `mc_tag` VALUES ('1332650453377708034', 'java', 1);
INSERT INTO `mc_tag` VALUES ('1332681213568589825', 'css', 1);
INSERT INTO `mc_tag` VALUES ('1332681213631504385', 'mongodb', 1);
INSERT INTO `mc_tag` VALUES ('1332682473218744321', 'python', 1);
INSERT INTO `mc_tag` VALUES ('1332913064463794178', 'vue', 2);
INSERT INTO `mc_tag` VALUES ('1332913064530903041', 'react', 1);
INSERT INTO `mc_tag` VALUES ('1333432347107143681', 'node', 1);
INSERT INTO `mc_tag` VALUES ('1333432347107143682', 'mysql', 1);
INSERT INTO `mc_tag` VALUES ('1333447953697177602', 'flask', 2);
INSERT INTO `mc_tag` VALUES ('1333676096320106498', 'spring', 1);
INSERT INTO `mc_tag` VALUES ('1333695976742268930', 'django', 1);
INSERT INTO `mc_tag` VALUES ('1334481725519429634', 'security', 1);
INSERT INTO `mc_tag` VALUES ('1349362401597775874', 'tensorflow', 1);
INSERT INTO `mc_tag` VALUES ('1349631541306732545', 'pytorch', 1);


-- ----------------------------
-- Table structure for bms_post_tag
-- ----------------------------
DROP TABLE IF EXISTS `mc_post_tag`;
CREATE TABLE `mc_post_tag`  (
                                 `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
INSERT INTO `mc_post_tag` VALUES (36, '1332650453377708034', '1332650453142827009');
INSERT INTO `mc_post_tag` VALUES (37, '1332681213568589825', '1332681213400817665');
INSERT INTO `mc_post_tag` VALUES (38, '1332681213631504385', '1332681213400817665');
INSERT INTO `mc_post_tag` VALUES (39, '1332682473218744321', '1332682473151635458');
INSERT INTO `mc_post_tag` VALUES (40, '1332913064463794178', '1332913064396685314');
INSERT INTO `mc_post_tag` VALUES (41, '1332913064530903041', '1332913064396685314');
INSERT INTO `mc_post_tag` VALUES (42, '1333432347107143681', '1333432347031646209');
INSERT INTO `mc_post_tag` VALUES (43, '1333432347107143682', '1333432347031646209');
INSERT INTO `mc_post_tag` VALUES (44, '1333447953697177602', '1333447953558765569');
INSERT INTO `mc_post_tag` VALUES (45, '1332913064463794178', '1333668258587750401');
INSERT INTO `mc_post_tag` VALUES (46, '1333676096320106498', '1333676096156528641');
INSERT INTO `mc_post_tag` VALUES (47, '1333695976742268930', '1333695976536748034');
INSERT INTO `mc_post_tag` VALUES (48, '1334481725519429634', '1334481725322297346');
INSERT INTO `mc_post_tag` VALUES (49, '1333447953697177602', '1335149981733449729');
INSERT INTO `mc_post_tag` VALUES (50, '1349362401597775874', '1349362401438392322');
INSERT INTO `mc_post_tag` VALUES (51, '1349631541306732545', '1349631541260595202');

-- ----------------------------
-- Table structure for bms_promotion
-- ----------------------------
DROP TABLE IF EXISTS `mc_promotion`;
CREATE TABLE `mc_promotion`  (
                                  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
INSERT INTO `mc_promotion` VALUES (1, '开发者头条', 'https://juejin.cn/', '开发者头条');
INSERT INTO `mc_promotion` VALUES (2, '并发编程网', 'https://juejin.cn/', '并发编程网');
INSERT INTO `mc_promotion` VALUES (3, '掘金', 'https://juejin.cn/', '掘金');


-- ----------------------------
-- Table structure for bms_tip
-- ----------------------------
DROP TABLE IF EXISTS `mc_tip`;
CREATE TABLE `mc_tip`  (
...
-- Records of bms_tip
-- ----------------------------
INSERT INTO `mc_tip` VALUES (1, '多锉出快锯，多做长知识。', '佚名', 1);
INSERT INTO `mc_tip` VALUES (2, '未来总留着什么给对它抱有信心的人。', '佚名', 1);
INSERT INTO `mc_tip` VALUES (3, '一个人的智慧不够用，两个人的智慧用不完。', '谚语', 1);
INSERT INTO `mc_tip` VALUES (4, '十个指头按不住十个跳蚤', '傣族', 1);
INSERT INTO `mc_tip` VALUES (5, '言不信者，行不果。', '墨子', 1);
INSERT INTO `mc_tip` VALUES (6, '攀援而登，箕踞而遨，则几数州之土壤，皆在衽席之下。', '柳宗元', 1);
INSERT INTO `mc_tip` VALUES (7, '美德大都包含在良好的习惯之内。', '帕利克', 1);
INSERT INTO `mc_tip` VALUES (8, '人有不及，可以情恕。', '《晋书》', 1);
INSERT INTO `mc_tip` VALUES (9, '明·吴惟顺', '法不传六耳', 1);
INSERT INTO `mc_tip` VALUES (10, '真正的朋友应该说真话，不管那话多么尖锐。', '奥斯特洛夫斯基', 1);
INSERT INTO `mc_tip` VALUES (11, '时间是一切财富中最宝贵的财富。', '德奥弗拉斯多', 1);
INSERT INTO `mc_tip` VALUES (12, '看人下菜碟', '民谚', 1);
INSERT INTO `mc_tip` VALUES (13, '如果不是怕别人反感，女人决不会保持完整的严肃。', '拉罗什福科', 1);
INSERT INTO `mc_tip` VALUES (14, '爱是春暖花开时对你满满的笑意', '佚名', 1);
INSERT INTO `mc_tip` VALUES (15, '希望是坚韧的拐杖，忍耐是旅行袋，携带它们，人可以登上永恒之旅。', '罗素', 1);
INSERT INTO `mc_tip` VALUES (18, '天国般的幸福，存在于对真爱的希望。', '佚名', 1);
INSERT INTO `mc_tip` VALUES (19, '我们现在必须完全保持党的纪律，否则一切都会陷入污泥中。', '马克思', 1);
INSERT INTO `mc_tip` VALUES (20, '在科学上没有平坦的大道，只有不畏劳苦沿着陡峭山路攀登的人，才有希望达到光辉的顶点。', '马克思', 1);
INSERT INTO `mc_tip` VALUES (21, '懒惰的马嫌路远', '蒙古', 1);
INSERT INTO `mc_tip` VALUES (22, '别忘记热水是由冷水烧成的', '非洲', 1);
...
-- Records of ums_user
-- ----------------------------
INSERT INTO `mc_user` VALUES ('1349290158897311745', 'admin', 'admin', '$2a$10$8qx711TBg/2hxfL7N.sxf.0ROMhR/iuPhQx33IFqGd7PLgt5nGJTO', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', '23456@qq.com', NULL, 2, '', '自由职业者', b'1', b'1', NULL, '2021-01-13 17:40:17', NULL);
INSERT INTO `mc_user` VALUES ('1349618748226658305', 'zhangsan', 'zhangsan', '$2a$10$7K3yYv8sMV5Xsc2facXTcuyDo8JQ4FJHvjZ7qtWYcJdei3Q6Fvqdm', 'https://s3.ax1x.com/2020/12/01/DfHNo4.jpg', '23456@qq.com', NULL, 0, '', '自由职业者', b'1', b'1', NULL, '2021-01-14 15:25:59', NULL);
